...
const useCases = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { titleKo: "신시장 진출", titleEn: "Expand into New Markets", descKo: "심층 소비자 인사이트와 타겟 전략으로 새로운 시장 및 리테일 채널 발굴", descEn: "Uncover new markets and retail channels with deep consumer insights and targeted strategies." },
    ],
  },
  {
    id: "agency",
  ...
  },
  {
    ...
    titleKo: "신뢰할 수 있는 데이터로 산업 전문성 확보",
    ...
    benefits: [
      { titleKo: "고객 문제 해결 & 전문성 강화", titleEn: "Solving Customer Problems & Gaining Expertise", descKo: "ECDB로 빠르게 산업 지식을 습득하고 고객 과제 해결을 위한 맞춤 솔루션 개발", descEn: "ECDB helps consultancies quickly gain industry knowledge and develop tailored solutions to tackle customer challenges." },
      { titleKo: "컨설턴트를 위한 실행 가능 데이터 인사이트", titleEn: "Actionable Data Insights for Consultants", descKo: "신뢰할 수 있고 쉽게 접근 가능한 데이터로 효과적인 데이터 기반 솔루션 생성", descEn: "Our platform provides reliable, easily accessible data, enabling consultants to create effective, data-backed solutions." },
      { titleKo: "효율적인 시장 이해", titleEn: "Efficient Market Understanding", descKo: "시장 트렌드를 빠르게 분석하고, 핵심 플레이어를 식별하며, 잠재 고객 발굴", descEn: "Quickly analyze market trends, identify key partners, and spot potential customers to stay ahead in the market." },
      { titleKo: "데이터 기반 전략 솔루션", titleEn: "Data-Driven Strategic Solutions", descKo: "고품질 데이터로 인사이트 개발 및 고객 성공을 이끄는 정보에 기반한 추천 제공", descEn: "Use high-quality data to develop insights and make informed recommendations that drive client success." },
    ],
  },
  {
    id: "software",
  ...
  },
  {
    ...
    benefits: [
      { titleKo: "리드 발굴 & 거래처 계획", titleEn: "Lead Generation & Account Planning", descKo: "양질의 리드 발굴, 주요 거래처 전략 수립, 데이터 기반 인사이트로 수요 예측", descEn: "Generate quality leads, plan strategies for key accounts, and forecast demand with data-driven insights." },
      { titleKo: "주요 거래처 관리를 위한 실행 가능 데이터", titleEn: "Actionable Data for Key Account Management", descKo: "신뢰할 수 있는 데이터로 빠르게 접근하여 주요 거래처 관리 및 정보에 기반한 의사결정 지원", descEn: "Quickly access reliable data to support key account management and informed decision-making." },
      ...
      { titleKo: "성장을 위한 데이터 기반 전략", titleEn: "Data-Driven Strategy for Growth", descKo: "실행 가능한 인사이트로 전략 최적화 및 신시장으로 효율적 확장", descEn: "Use actionable insights to optimize strategies and expand efficiently into new markets." },
    ],
  },
  {
    id: "payment",
  ...
  },
  {
    ...
    subtitleKo: "온라인 거래 및 이커머스 분석을 위한 최고 수준의 플랫폼으로 학생들을 지원하세요.",
    ...
    benefits: [
      { titleKo: "학제간 유연한 활용", titleEn: "Flexible Use Cases Across Disciplines", descKo: "광범위한 학문 분야와 연구 주제에 맞는 데이터로 다양한 연구 니즈 지원", descEn: "Support diverse research needs with data that fits a wide range of academic fields and study focuses." },
      ...
      { titleKo: "과학적 무결성을 갖춘 신뢰할 수 있는 데이터", titleEn: "Reliable Data with Scientific Integrity", descKo: "학술 및 과학 기준에 따라 준비된 투명하고 검증된 데이터로 연구 수행", descEn: "Work with transparent, verified data prepared according to academic and scientific standards." },
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-gray-600">하나의 시장 인텔리전스 소스,</span>
              <br />
              <span className="text-primary">무한한 산업별 활용</span>
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              다양한 산업의 각기 다른 니즈를 충족합니다. 소규모 팀부터 글로벌 기업까지, ECDB의 구조화된 접근 방식으로 인사이트를 발굴하고 복잡성을 줄이며 자신감 있게 행동하세요.
            </p>
          </div>
                ...
                <div key={useCase.id} className="bg-gray-50 rounded-2xl p-8 md:p-12">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <h3 className="text-xl font-bold">{useCase.labelKo} 기업</h3>
                    </div>
                  </div>
