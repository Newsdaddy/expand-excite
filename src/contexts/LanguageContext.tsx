...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'solution.title': '어떤 목적으로 활용하시나요?',
    'solution.track1.title': '시장 진출 의사결정',
    'solution.track1.desc': '리테일, 제조, 소프트웨어 & 테크 기업을 위한',
    'solution.track1.f1.title': '시장/채널 선정',
    'solution.track1.f1.desc': '국가별 시장 규모, 성장률, 경쟁 밀도 비교 분석',
    'solution.track1.f2.title': '플랫폼 전략',
    'solution.track1.f2.desc': '카테고리별 최적 플랫폼 및 진입 전략 도출',
    'solution.track1.f3.title': '확장 우선순위',
    'solution.track1.f3.desc': '데이터 기반 시장 진입 로드맵 수립',
    'solution.track2.title': '성장 기업 발굴 & 타깃팅',
    'solution.track2.desc': '배송 & 물류, 결제, 소프트웨어 & 테크 기업을 위한',
    'solution.track2.f1.title': '급성장 기업 포착',
    'solution.track2.f1.desc': '실거래 데이터 기반 고성장 스토어/마켓플레이스 식별',
    'solution.track2.f2.title': '니즈 급증 기업',
    'solution.track2.f2.desc': '물류/결제/솔루션 니즈가 급증하는 기업 선제 파악',
    'solution.track2.f3.title': '의사결정자 리드',
    'solution.track2.f3.desc': '10만+ DB에서 타깃 기업 담당자 즉시 추출',
    'solution.track3.title': '전문 분석 & 리서치',
    'solution.track3.desc': '에이전시, 컨설팅, 금융 & 투자, 대학 & 기관을 위한',
    'solution.track3.f1.title': '시장 인텔리전스',
    'solution.track3.f1.desc': '글로벌 이커머스 시장 트렌드 및 경쟁 구도 분석',
    'solution.track3.f2.title': 'CDD & 밸류에이션',
    'solution.track3.f2.desc': '투자 대상 기업의 실거래 기반 성과 검증',
    'solution.track3.f3.title': '연구 데이터',
    'solution.track3.f3.desc': '학술 연구 및 클라이언트 프로젝트용 검증된 데이터셋',
    
    // Features Section
    'features.label': 'Features',
    'features.title': 'ECDB가 제공하는 것',
    'features.subtitle1': '❌ 무작위 데이터 수집 →',
    'features.subtitle2': '✅ 실거래 기반 모델링 데이터',
    ...
    'features.f2.desc': '경쟁사 분석, 커머스 실거래, 마케팅 분석용 KPI로 시장 실구조 파악',
    'features.f3.title': 'Growth Tracking',
    'features.f3.desc': '성장 중인 기업을 사전 포착해 선제적 영업 기회 확보',
    'features.f4.title': 'Lead Database',
    'features.f4.desc': '10만+ 의사결정자 DB - 직급, 부서, 기업 성장률 기반 필터링',
    'features.f5.title': 'Smart Filtering',
    'features.f5.desc': '국가, 플랫폼 타입, 성장 지표 기반 플레이어 분석',
  ...
  en: {
    ...
    // Solution Section
    'solution.label': 'Solution',
    'solution.title': 'What do you need it for?',
    'solution.track1.title': 'Market Entry Decision',
    'solution.track1.desc': 'For Retail, Manufacturing, Software & Tech',
    'solution.track1.f1.title': 'Market/Channel Selection',
    'solution.track1.f1.desc': 'Compare market size, growth rate, and competition by country',
    'solution.track1.f2.title': 'Platform Strategy',
    'solution.track1.f2.desc': 'Identify optimal platforms and entry strategies by category',
    'solution.track1.f3.title': 'Expansion Prioritization',
    'solution.track1.f3.desc': 'Build data-driven market entry roadmaps',
    'solution.track2.title': 'Growth Company Discovery & Targeting',
    'solution.track2.desc': 'For Shipping & Logistics, Payment, Software & Tech',
    'solution.track2.f1.title': 'Capture Fast-Growing Companies',
    'solution.track2.f1.desc': 'Identify high-growth stores/marketplaces based on transaction data',
    'solution.track2.f2.title': 'Surging Demand Companies',
    'solution.track2.f2.desc': 'Proactively identify companies with surging logistics/payment/solution needs',
    'solution.track2.f3.title': 'Decision-Maker Leads',
    'solution.track2.f3.desc': 'Instantly extract target company contacts from 100K+ database',
    'solution.track3.title': 'Professional Analysis & Research',
    'solution.track3.desc': 'For Agency, Consulting, Finance & Investment, University & Institution',
    'solution.track3.f1.title': 'Market Intelligence',
    'solution.track3.f1.desc': 'Global ecommerce market trends and competitive landscape analysis',
    'solution.track3.f2.title': 'CDD & Valuation',
    'solution.track3.f2.desc': 'Transaction-based performance verification for investment targets',
    'solution.track3.f3.title': 'Research Data',
    'solution.track3.f3.desc': 'Verified datasets for academic research and client projects',

    // Features Section
    'features.label': 'Features',
    'features.title': 'What ECDB Provides',
    'features.subtitle1': '❌ Random data collection →',
    'features.subtitle2': '✅ Transaction-based modeled data',
