...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'hero.title1': '글로벌 이커머스 시장의',
    'hero.title2': '의사결정 + 세일즈',
    'hero.title3': '종합솔루션',
    'hero.sub1': '어디에 진출할지',
  ...
  en: {
    ...
    'hero.title2': 'Decision + Sales',
    'hero.title3': 'Total Solution',
    'hero.sub1': 'Where to expand',
    'hero.sub2': 'Which platform to partner with',
    'hero.sub3': 'Who to sell to first',
    ...
    'problem.subtitle': 'Both decisions and sales are slowing down',
    'problem.item1.title': 'No Cross-Country Benchmarks',
    'problem.item1.desc': 'Global commerce markets lack standardized comparison criteria.',
    'problem.item2.title': 'Platform Selection by Intuition',
    'problem.item2.desc': 'Quantified and reliable platform KPI data is unavailable.',
    'problem.item3.title': 'Unclear Partnership Targets',
    'problem.item3.desc': 'Uncertain which marketplace or online store to partner with first.',
    ...
    // Solution Section
    'solution.label': 'Solution',
    'solution.title': 'Complete Solution with Two Tracks',
    'solution.track1.title': 'Expansion Decision Intelligence',
    ...
    'solution.track2.f1.title': 'Growth Company Detection',
    'solution.track2.f1.desc': 'Identify rapidly growing marketplaces and online stores',
    'solution.track2.f2.title': 'Rising Demand Companies',
    ...
    'features.subtitle2': '✅ Essential commerce company KPIs and lists you need now',
    ...
    'pricing.consultBtn': 'Get Consultation',
    ...
    'why.old3': 'Internal lead DB → Outdated and unpriorized',
    ...
    // Contact Section
    'contact.label': 'Dedicated Manager',
    'contact.title': 'Consult with Byeongjin Jeong',
    'contact.subtitle1': 'Contract through Manager Byeongjin Jeong',
    'contact.subtitle2': 'for exclusive first-contract benefits',
    'contact.name': 'Byeongjin Jeong',
    'contact.role': 'APAC Country Manager',
    'contact.benefit1.title': 'Tailored Consulting',
    'contact.benefit1.desc': 'Customized solutions for your business needs',
    'contact.benefit2.title': 'Dedicated Process Management',
    ...
    'contact.benefit3.desc': 'Special benefits available only through Manager Byeongjin Jeong',
    'contact.demoBtn': 'Book a Demo',
    'contact.consultBtn': 'Get Consultation',
    ...
    'cta.consultBtn': 'Get Consultation',
