...
const defaultResources = [
  ...
  },
  {
    id: "7",
    category: "ax" as CategoryType,
    title: "BJ Sales Ops Stack",
    titleKo: "BJ 세일즈 옵스 스택",
    description: "Complete overview of AI-powered sales operations stack for modern B2B teams",
    descKo: "AI 기반 B2B 세일즈 운영 스택 전체 구성도",
